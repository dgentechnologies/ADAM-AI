 ...
 *
 * Google sign-in is stubbed: no OAuth client is wired in this pass, so the button
 * marks the store signed-in and advances. The terms checkbox gates the CTA
 * because the Stitch screen implies consent before continuing.
 */
export default function SignInPage() {
  ...
  return (
    <Screen className="relative min-h-0 flex-1 justify-between pt-0 pb-safe pb-stack-md">
      {/* Dynamic CanvasRevealEffect Dot Matrix Background from Prompt */}
