...
## Typography
This design system utilizes **Inter** for its geometric precision and modern clarity. 

- **Headlines:** Must be bold and impactful with tight negative letter-spacing to create a "confident" and "architectural" feel. 
...
- **Scalability:** On mobile devices, display sizes should scale down to ensure they remain within the viewport while maintaining their bold visual weight.
...
- **Cards/Panels:** A consistent 24px corner radius creates a friendly, "handheld" feel for hardware-like UI components.
...
## Components
- **Buttons:** 
  - *Primary:* Pill-shaped, Solid White fill, Black text. High-contrast, maximum prominence.
